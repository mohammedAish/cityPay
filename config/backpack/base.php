...
return [
   ...
   // 'header_class' => 'app-header navbar navbar-color bg-yellow border-0',
   ...
   // 'sidebar_class' => 'sidebar sidebar-pills bg-light',
    ...
    'developer_name' => 'CTPAY',

    // Developer website. Link in footer. Type false if you want to hide it.
    'developer_link' => 'https://ctpay.uk',
    ...
    */
    ...
    'authentication_column_name' => 'الايميل',
