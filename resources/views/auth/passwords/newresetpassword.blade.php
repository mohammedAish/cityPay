        ...
        <section class="container-fluid style-rtl">
            <div class="row justify-content-around ">
                <div class="col-md-5 style-container-form ">
                    ...
                    <form class="style-container-form" action="#!">
                        ...
                        <div class="form-group">
                            <div class="inner-addon right-addon">
                                ...
                                <input type="password" class="form-control input-style mb-4" placeholder="new password">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="inner-addon right-addon">
                                <i class="fas fa-user-lock glyphicon"></i>
                                <input type="password" class="form-control input-style mb-4" placeholder="confirm password">
                            </div>
                        </div>
                ...
                <div class="col-md-6  pt-5 style-respinsvie ">
                    ...
                    <img src="{{ asset('assets_v3/assets/img/Nowpasswordwith.png') }}" class="img-fluid   pt-5" />
