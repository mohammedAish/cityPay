                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Your Post Title" name="title" />
                                    </div>
                                    <div class="form-group">
                                        <label>FAQ Content</label>
                                        <textarea rows="10" class="form-control nicEdit" placeholder="Post description" name="body"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
