            ...
            <div class="modal-body scroll-y ">
                <div class="row">
                    <div class="d-flex flex-column">
                        ...
                        <div class="d-flex flex-row">
                            <div>
                                <p class="style-label-form">{{cp('min_deposit_amount')}} :</p>
                            </div>
                            <div class="px-2">
                        ...
                        <div class="d-flex flex-row">
                            <div>
                                <p class="style-label-form">{{cp('max_deposit_amount')}} :</p>
                            </div>
                            <div class="px-2">
            ...
            <div class="modal-header">
                <div>
                    <h2 class="fw-bolder style-Address-Modal">
                        ...
                        <span class="px-1">{{cp('kt_modal_success_title')}}</span>
                    </h2>
...
<div class="modal fade" id="kt_modal_Quick_introductory_tour" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered mw-800px">
        <div class="modal-content">
            <video class="ratio ratio-16x9" title="{{cp('quick_introductory_tour')}}" draggable="false" contextmenu="false" poster="/assets_v2/media/imagesWebsite/ImageVideoTour.jpg" contenteditable="false" itemscope controls>
...
<div class="modal fade" id="kt_modal_Found_Error_data" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered mw-450px">
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y ">
                <form id="errorReportForm" action="{{route('send_error_report')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-12">
                            <span id="error_msg_report" style="color: red"></span>
                            <div class="col-md-12 my-3">
                                <label class="style-label-form">{{cp('error_link')}}</label>
                                <input type="text" class="form-control" required name="error_link"/>
                            </div>
                            <div class="col-md-12 my-3">
                                <label class="style-label-form">{{cp('what_you_done_before_error')}}</label>
                                <input type="text" class="form-control" required name="error_action"/>
                            </div>
                            <div class="col-md-12 my-3">
                                <label class="style-label-form">{{cp('download')}}</label>
                                ...
                                <label class="pt-3 style-title-bio-card2 ">
                                    {{cp('upload_file_or_image_of_error')}} ({{cp('not_more_that_mb')}} , PDF, PNG ,GIF ,JPG ,JPEG)
                                </label>
                            </div>
        ...
        <div class="topbar  text-center d-flex py-3   flex-shrink-0" style="justify-content: center;">
            ...
            <div class="d-flex mx-4 style-icons-footer-bottom-Mobile  align-items-center  ms-1 ms-lg-3">
                ...
                <div class="topbar-item flex-column active position-relative px-2" data-kt-menu-trigger="click"
                     ...
                     onclick="window.location.replace('{{url('/wallet/dashboard')}}')"
                >
...
{{--                    </a>--}}
            ...
            <div class="d-flex mx-4 style-icons-footer-bottom-Mobile align-items-center flex-column ms-1 ms-lg-3">
                ...
                <div class="topbar-item flex-column position-relative px-2" data-kt-menu-trigger="click"
                     data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end" data-kt-menu-flip="bottom"
                     onclick="window.location.replace('{{route('list_deposit_withdraws')}}')">
{{--                    <a href="{{route('list_deposit_withdraws')}}">--}}
...
{{--                    </a>--}}
            ...
            <div class="d-flex mx-4  style-icons-footer-bottom-Mobile align-items-center flex-column ms-1 ms-lg-3">
                ...
                <div class="topbar-item flex-column position-relative px-2" data-kt-menu-trigger="click"
                     data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end" data-kt-menu-flip="bottom"
                     onclick="window.location.replace('{{url('/account/profile/dashboard')}}')">
{{--                    <a href="{{url('/account/profile/dashboard')}}">--}}
