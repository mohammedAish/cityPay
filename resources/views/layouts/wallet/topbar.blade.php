<div class="d-flex align-items-stretch flex-shrink-0">
    ...
    <div class="topbar style-respoinsive-hide-icons-header-disktop d-flex align-items-stretch flex-shrink-0">
        <!--begin::Search-->
                        ...
                        @foreach($notifications as $notification)
                            <div class="d-flex flex-column py-2   style-background-Notifications">
                                <div class="d-flex align-items-center py-3 style-border-bottom-Notifications">
                                    ...
                                    <div class="mb-0 ">
                                        <a href="{{route('notification_show', ['id' => $notification->id])}}"
                                           class="fs-6 style-text-Notifications-read fw-bolder">
                                            @if(strpos($notification->data['subject'], '_') !== false)
                                                {{cp($notification->data['subject'])}}
                                            @else
                    ...
                    <div class="py-1 text-center " style="background-color:#E51C39;">
                        <a href="{{route('notifications')}}"
                           class="btn btn-color-gray-600 btn-active-color-primary">
                            ...
                            <span class="style-text-Notifications-read text-white">{{cp('view_all')}}</span>
                        </a>
                    </div>
            </div>
        @endif
        ...
        <div class="d-flex align-items-center ms-1 ms-lg-3">
            ...
            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-200px"
                ...
                <div class="menu-item px-3 my-1">
                    <a href="{{route('change_lang', ['abbr' => 'ar'])}}"
                       class="style-menu-link px-3 active">
                                                    <span class="menu-icon">
                                                        <img src="/assets_v2/media/imagesWebsite/Language.png">
                                                    </span>
                        <span class="style-menu-title px-2">{{cp('arabic')}}</span>
                    </a>
                </div>
                <!--end::Menu item-->
                <!--begin::Menu item-->
                <div class="menu-item px-3 my-1">
                    <a href="{{route('change_lang', ['abbr' => 'en'])}}" class="style-menu-link px-3 ">
                                                    <span class="menu-icon">
                                                        <img src="/assets_v2/media/imagesWebsite/Engilsh.png">
                                                    </span>
                        <span class="style-menu-title  px-2">{{cp('english')}}</span>
                    </a>
                </div>
                <!--end::Menu item-->
            </div>
        ...
        <div class="d-flex align-items-center ms-1 ms-lg-3">
            ...
            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-200px"
                ...
                <!--begin::Menu item-->
                <div class="menu-item px-3 my-1">
                    <a href="{{url('/account/profile/dashboard')}}" class="style-menu-link px-3 active">
                                                    <span class="menu-icon">
                        ...
                        <span class="style-menu-title px-2">{{cp('personal_account')}}</span>
                    </a>
                </div>
                <!--end::Menu item-->
                <!--begin::Menu item-->
                <div class="menu-item px-3 my-1">
                    <a href="{{route("profile.dashboard") . '#kt_Record_activities_tab'}}" class="style-menu-link px-3 active">
                                                    <span class="menu-icon">
                        ...
                        <span class="style-menu-title px-2">{{cp('history')}}</span>
                    </a>
                </div>
            {{--                                <div class="menu-item px-3 my-1">--}}
            {{--                                    <a href="#" class="style-menu-link px-3 active">--}}
            {{--                                                    <span class="menu-icon">--}}
            {{--                                                        <img src="/assets_v2/media/imagesWebsite/fdsg.png">--}}
            {{--                                                    </span>--}}
            {{--                                        <span class="style-menu-title px-2">إحالاتي</span>--}}
            {{--                                    </a>--}}
            {{--                                </div>--}}
            {{--                                <div class="menu-item px-3 my-1">--}}
            {{--                                    <a href="#" class="style-menu-link px-3 active">--}}
            ...
            {{--                                                             xmlns="http://www.w3.org/2000/svg">--}}
            {{--                                                            <path d="M0 1.875C0 1.37772 0.197544 0.900805 0.549175 0.549175C0.900806 0.197544 1.37772 0 1.875 0H13.125C13.6223 0 14.0992 0.197544 14.4508 0.549175C14.8025 0.900805 15 1.37772 15 1.875V6.5625H0V1.875ZM10.7812 2.8125C10.6569 2.8125 10.5377 2.86189 10.4498 2.94979C10.3619 3.0377 10.3125 3.15693 10.3125 3.28125V4.21875C10.3125 4.34307 10.3619 4.4623 10.4498 4.55021C10.5377 4.63811 10.6569 4.6875 10.7812 4.6875H12.6562C12.7806 4.6875 12.8998 4.63811 12.9877 4.55021C13.0756 4.4623 13.125 4.34307 13.125 4.21875V3.28125C13.125 3.15693 13.0756 3.0377 12.9877 2.94979C12.8998 2.86189 12.7806 2.8125 12.6562 2.8125H10.7812ZM0 8.4375V9.375C0 9.87228 0.197544 10.3492 0.549175 10.7008C0.900806 11.0525 1.37772 11.25 1.875 11.25H13.125C13.6223 11.25 14.0992 11.0525 14.4508 10.7008C14.8025 10.3492 15 9.87228 15 9.375V8.4375H0Z"--}}
            {{--                                                                  fill="black"></path>--}}
            {{--                                                        </svg>--}}
            {{--                                                    </span>--}}
            {{--                                        <span class="style-menu-title px-2">بطاقاتي</span>--}}
            {{--                                    </a>--}}
            {{--                                </div>--}}
            <!--end::Menu item-->
            </div>
        ...
        <div class="d-flex align-items-center ms-1 ms-lg-3">
            ...
            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-200px"
                ...
                <!--begin::Menu item-->
                <div class="menu-item px-3 my-1">
                    <a href="{{route("logout")}}" class="style-menu-link px-3 active">
                                                    <span class="menu-icon">
                                                        <i class="fas fa-sign-out-alt text-dark"
                                                           style="font-size:16px;"></i>
                                                    </span>
                        <span class="style-menu-title px-2">{{cp('logout_str')}}</span>
                    </a>
                </div>
        ...
        <div class="d-flex align-items-stretch" id="kt_header_user_menu_toggle">
            ...
            <div class="topbar-item cursor-pointer symbol px-3 px-lg-5 me-n3 me-lg-n5 symbol-30px symbol-md-35px"
                 data-kt-menu-trigger="click" data-kt-menu-attach="parent"
                 data-kt-menu-placement="bottom-end" data-kt-menu-flip="bottom">
                <img src="{{asset(auth()->user()->img_profile )}}"
                     class="style-image-Preonal-user " width="35px"
                     alt="">
                <span class="px-2 style-Name-user-dropdown">{{auth('customers')->user()->first_name}}</span>
                ...
                <div class="menu-item px-3">
                    <div class="menu-content d-flex align-items-center px-3">
                        ...
                        <div class="symbol symbol-50px me-5">
                            <img alt="Logo" src="{{asset(auth()->user()->img_profile )}}"
                                 width="50px">
                        </div>
                        <!--end::Avatar-->
                        <!--begin::Username-->
                        <div class="d-flex flex-column">
                            <div class="d-flex flex-row">
                                ...
                                <div class="style-icon-copy-dropdown-user">
                                    <a href="#" onclick="CopyToClipboardProfile('wallet_code_symbol')"><span class="badge  fw-bolder fs-8 px-2 py-1 ms-2">
                            ...
                            <a href="#"
                               class="fw-bold text-muted  style-text-number-wallet2 text-hover-primary fs-7" id="wallet_code_symbol">{{auth()->user()->wallet_code_symbol}}</a>
                        </div>
                        <!--end::Username-->
                    </div>
                </div>
                ...
                <div class="menu-item px-3">
                    <div class="menu-content d-flex align-items-center px-3">
                        ...
                        <div class="d-flex flex-column px-4">
                            ...
                            <a href="{{route('profile_info')}}"
                               class="fw-bold style-text-number-wallet2 text-muted text-hover-primary fs-7">{{auth()->user()->is_verified == 1 ? cp('verified') : cp('unverified')}}</a>
                        </div>
                        <!--end::Username-->
                    </div>
                </div>
                ...
                <div class="menu-item px-3">
                    <div class="menu-content d-flex align-items-center px-3">
                        ...
                        <div class="d-flex flex-column px-4">
                            ...
                            <a href="#"
                               class="fw-bold style-text-number-wallet2 text-muted text-hover-primary fs-7">{{auth()->user()->created_at->format('Y.m.d')}}</a>
                        </div>
                        <!--end::Username-->
                    </div>
                </div>
...
<script>
    function CopyToClipboardProfile(containerid) {
