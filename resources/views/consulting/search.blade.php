                    ...
                    <div class="results" style="flex-direction: row;">
                        ...
                        <div class="course-card" style="flex-direction: row;">
                            <figure class="col-md-3" style="padding-right: 0;">
                                <img src="{{asset('/org_assets/dist/img/courseimg/course-image-4.png')}}"  alt="">
                            </figure>
                        ...
                        <div class="course-card" style="flex-direction: row;">
                            <figure class="col-md-3" style="padding-right: 0;">
                                <img src="{{asset('/org_assets/dist/img/courseimg/course-image-5.png')}}" alt="">
                            </figure>
                            <div class="course-card-content col-md-9">
                                <h5>هذا النص هو مثال لنص يمكن أن يستبدل في نفس المساحة</h5>
                                <p>4.5 (25,428 تقييمات)</p>
                        ...
                        <div class="course-card" style="flex-direction: row;">
                            <figure class="col-md-3" style="padding-right: 0;">
                                <img src="{{asset('/org_assets/dist/img/courseimg/course-image-3.png')}}" alt="">
                            </figure>
                            <div class="course-card-content col-md-9">
                                <h5>هذا النص هو مثال لنص يمكن أن يستبدل في نفس المساحة</h5>
                                <p>4.5 (25,428 تقييمات)</p>
                        ...
                        <div class="course-card" style="flex-direction: row;">
                            <figure class="col-md-3" style="padding-right: 0;">
                                <img src="{{asset('/org_assets/dist/img/courseimg/course-image-2.png')}}" alt="">
                            </figure>
                            <div class="course-card-content col-md-9">
                                <h5>هذا النص هو مثال لنص يمكن أن يستبدل في نفس المساحة</h5>
                                <p>4.5 (25,428 تقييمات)</p>
                        ...
                        <div class="course-card" style="flex-direction: row;">
                            <figure class="col-md-3" style="padding-right: 0;">
                                <img src="{{asset('/org_assets/dist/img/courseimg/course-image-1.png')}}" alt="">
                            </figure>
                            <div class="course-card-content col-md-9">
                                <h5>هذا النص هو مثال لنص يمكن أن يستبدل في نفس المساحة</h5>
                                <p>4.5 (25,428 تقييمات)</p>
