<!--for roue addLoverAccounts-->
@extends('wallet.index')
@section('content')

    <div class="wallet-box-scroll">
        <div class="wallet-bradcrumb">
            <h2><i class="fas fa-user"></i>اضافة حساب احباء مالي :</h2>
            <br>
            <h5 style="color: grey">الرجاء ادخال بيانات الحساب بشكل صحيح لأنه سيتم استخدام الحساب في عمليات التحويل   </h5>
        </div>
        <div class="profile-page-area clearfix">
            <div class="profile-page-area-main row col-md-12">
                <div class="profile-information-right col-md-12">
                    <div class="profile-information-box ">
                        <h2 style=" margin-right: 10px;">

                            <span class="step-icon "><i class="zmdi zmdi-folder-person"></i></span>
                        ...
                        <div class="theme-input-box">
                            ...
                            <input type="text" name="" value="ايمان محمد اللوندي" class="theme-input">
                        </div>
                        <div class="theme-input-box">
                            <label>العنوان</label>
                            <input type="text" name="" value="صنعاء الستين الشمالي " class="theme-input">
                        </div>
                        <div class="theme-input-box">
                            <label>البريد الالكتروني</label>
                            <input type="email" name="" value="eman@gmail.com" class="theme-input">
                        </div>
                        <div class="theme-input-box">
                            <label>التلفون</label>
                            <input type="" name="" value="+967777789403" class="theme-input">
                        </div>
                                ...
                                <div class="form-row form-row-date">
                                    ...
                                    <div class="form-holder form-holder-2 col-md-9">
                                        ...
                                        <select name="country" id="country" style="display: inline-block">
                                            <option value="Month" disabled selected>الدولة</option>
                            ...
                            <div class="inner ">
                                <div class="form-row form-row-date">
                                    ...
                                    <div class="form-holder form-holder-2 col-md-9">
                                        ...
                                        <select name="country" id="country"  style="display: inline-block">
                                            <option value="Month" disabled selected> نوع الحساب </option>
                            ...
                            <div class="inner ">
                                <div class="form-row form-row-date">
                                    ...
                                    <div class="form-holder form-holder-2 col-md-9">
                                        ...
                                        <select name="country" id="country"  style="display: inline-block">
                                            <option value="" disabled selected> اسم البنك </option>
                                            <option value="">
                ...
                <div class="bank_box profile-information-right col-md-6">
                    ...
                    <div class="text-center">
                        ...
                        <div class="theme-input-box">
                            <label><h3>
                                    قم بادخال رقم الحساب بشكل صحيح
                                </h3>
                            </label>
                ...
                <div class="profile-btn">
                    <button class="theme-btn">حفظ</button>
                </div>
            </div>
