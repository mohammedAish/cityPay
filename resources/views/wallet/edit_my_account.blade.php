                ...
                <form id="form_data">
                    ...
                    <div class="row">
                        <div class="col-md-5 my-2">
                            ...
                            <select id="deposit_type" data-control="select2"
                                    data-placeholder="{{cp('add_finance_account_system_description')}}"
                                    data-hide-search="true"
                                    disabled
                                    class="form-select style-select-profile style-label-form  ">
                                <option value="{{$finance_account->agency->depositMethod->id}}">{{$finance_account->agency->depositMethod->name}}</option>
                            </select>
                            <input type="hidden" name="deposit_type" value="{{$finance_account->agency->depositMethod->id}}">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-5 my-2">
                            ...
                            <select name="agency_id" id="agency_section" data-control="select2"
                                    ...
                                    disabled
                                    class="form-select style-select-profile style-label-form">
                                <option value="{{$finance_account->agency->id}}">{{$finance_account->agency->name}}</option>
                            </select>
                            <input type="hidden" name="agency_id" value="{{$finance_account->agency->id}}">
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-5 my-2 localbankaccount">
                                ...
                                <input name="recipient_name_local" type="text"
                                       value="{{$finance_account->recipient_name}}"
                            ...
                            <div class="col-md-5 my-2 localbankaccount">
                                ...
                                <input name="phone_number_local" type="text"
                                       value="{{$finance_account->phone_number}}"
                        ...
                        <div class="row">
                            <div class="col-md-5 my-2">
                                ...
                                <input name="wallet_number_crypto" type="text"
                                       value="{{$finance_account->wallet_number}}"
                        ...
                        <div class="row">
                            <div class="col-md-5 my-2 localbankaccount">
                                ...
                                <input name="customer_agency_acc_name" type="text"
                                       value="{{$finance_account->customer_agency_acc_name}}"
                                       placeholder="{{cp('account_name_placeholder')}}" class="form-control"/>
                            </div>
                            <div class="col-md-5 my-2 localbankaccount">
                                <label class="style-label-form">{{cp('account_number')}}</label>
                                <input name="customer_agency_acc_number" type="text"
                                       value="{{$finance_account->customer_agency_acc_number}}"
                    ...
                    <div class="row">
                        <div class="col-md-5 mt-3">
                            <button type="button" id="save-form"
                                    class="form-control BntAdd-Modal">{{cp('edit_account')}}
                            </button>
                        </div>
                    </div>
                </form>
...
@section("custom_js")
    <script type="text/javascript">
        ...
        expresstransfer.style.display = "none";
        ...
        let depositMethod = '{{$finance_account->agency->depositMethod->id}}';

        expresstransfer.style.display = (depositMethod == 1) ? "block" : "none";
        // localbankaccount.style.display = (depositMethod == 3) ? "block" : "none";
        Cryptocurrency.style.display = (depositMethod == 4) ? "block" : "none";
        electronicbanking.style.display = (depositMethod == 2) ? "block" : "none";
        Internationallocalbankaccount.style.display = (depositMethod == 12) ? "block" : "none";
