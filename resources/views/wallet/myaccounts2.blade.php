                ...
                <div class="page-title style-boder-titel-card d-flex flex-column   ">
                    <h1 class="style-title-card px-4 py-4">
                                    <span class="fw-bolder mb-2 text-dark">
                                        {{trans('lang.my-finical-accounts')}}
                                    </span>
                    </h1>
        ...
        <div class="row style-right mx-3 my-3">
            <div class="col-md-3 my-3">
                <div class=" card style-card-Add-account-money">
                    <a href="{{route('wallet.add_finance_account')}}" class="card-body">
                        ...
                        <p class="style-card-Add-account-money-title">{{trans('lang.add_account')}}</p>
                    </a>
                </div>
            </div>
                ...
                @if($account->agency!=null)
                    ...
                    >
                        <div class=" card style-card-Add-account-money-img">
                            <div class="card-body">
                                <img src="{{asset($account->agency->img_path)}}" width="70px" class="py-4"/>
                            </div>
                        </div>
                    </div>
                @endif
...
@section("custom_js")
    <script type="text/javascript">
        $('.edit_customer_agency_btn').click(function () {
            ...
            $('#agency_img').prop('src', '{{asset('/')}}' + data.img_path)
            ...
            $('#edit_link').prop('href', '{{url('')}}' + '/wallet/my_accounts/' + $(this).attr('account_id'))
