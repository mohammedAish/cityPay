                ...
                <div class="table-responsive">
                    <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer"
                        ...
                        <tr class="style-row-table">
                            ...
                            <th class="min-w-80px style-Title-colume-table">{{cp('original_price')}}</th>
                            <th class="min-w-100px style-Title-colume-table">{{cp('commission')}}</th>
                            <th class="min-w-100px style-Title-colume-table">{{cp('final_price')}}</th>
                        ...
                        <tbody>
                        @include('wallet.processes.partials.tables._pay_bills_requests')
                        </tbody>
                        <!--end::Table body-->
                    </table>
                </div>
