...
@section('content')
    <section>
                    ...
                    <li class="nav-item">
                        <a class="nav-link style-table-nav-link" data-kt-countup-tabs="true" data-bs-toggle="tab"
                           href="#withdrawal_requests_tab">
                            {{cp('processes_withdraw')}}
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link style-table-nav-link" data-kt-countup-tabs="true" data-bs-toggle="tab"
                           href="#transfer_requests_tab">
                            {{cp('processes_transfer')}}
                        </a>
                    </li>
                    <li class="nav-item d-none">
                        <a class="nav-link style-table-nav-link" data-kt-countup-tabs="true" data-bs-toggle="tab"
                           href="#pay_bills_requests_tab">
                            {{cp('processes_pay_bills')}}
                        </a>
                    </li>
                    <li class="nav-item d-none">
                        <a class="nav-link style-table-nav-link" data-kt-countup-tabs="true" data-bs-toggle="tab"
                           href="#freelance_platforms_tab">
                            {{cp('processes_withdrawing_profits_from_freelance_platforms')}}
                        </a>
                    </li>
                    <li class="nav-item d-none">
                        <a class="nav-link style-table-nav-link" data-kt-countup-tabs="true" data-bs-toggle="tab"
        ...
        <div class="tab-content" id="myTabContent">
            @include('wallet.processes.partials.all_processes_tab')
            @include('wallet.processes.partials.deposit_requests_tab')
            @include('wallet.processes.partials.withdrawal_requests_tab')
            @include('wallet.processes.partials.transfer_requests_tab')
            @include('wallet.processes.partials.pay_bills_requests_tab')
            @include('wallet.processes.partials.freelance_platforms_tab')
        </div>
                ...
                <div class="modal-header">
                    <div>
                        <h2 class="fw-bolder style-Address-Modal">
                            ...
                            <span class="px-1">{{cp('upload-payment-invoice')}}</span>
                        </h2>
