...
!function (t) {
    ...
    function y(t, e) {
        "pending" === t._state && (t._state = "settled", t._data = e, h(g, t))
    }
    ...
    function A(t) {
        t._state = "rejected", w(t), !t._handled && f && global.process.emit("unhandledRejection", t._data, t)
    }
    ...
    function _(t, e) {
        ...
        }, r = e.document || r, a = c.bind(c, r, ["fa", "fab", "fas", "far", "fal", "fad"]);
        ...
        var f = u.map((function (n) {
            return new E((function (r, c) {
                S(i(t, {addOn: n.addOn, minify: t.minify.enabled}), e).then((function (i) {
    ...
    function C(t, e) {
        e.autoA11y = t.autoA11y.enabled, "pro" === t.license && (e.autoFetchSvg = !0, e.fetchSvgFrom = t.baseUrl + "/releases/" + ("latest" === t.version ? "latest" : "v".concat(t.version)) + "/svgs");
        var n = [];
        return t.v4shim.enabled && n.push(new E((function (n, r) {
            S(i(t, {addOn: "-v4-shims", minify: t.minify.enabled}), e).then((function (t) {
                n(T(t, o({}, e, {id: "fa-v4-shims"})))
            })).catch(r)
        }))), n.push(new E((function (n, r) {
            S(i(t, {minify: t.minify.enabled}), e).then((function (t) {
    ...
    try {
        if (window.FontAwesomeKitConfig) {
            var I = window.FontAwesomeKitConfig, k = {
            ...
            (function () {
                ...
                return "js" === t.method ? C(t, e) : "css" === t.method ? _(t, e, (function (t) {
                    F(t), L(t)
                })) : void 0
            })(I, k).then((function (t) {
                t.map((function (t) {
                    return x.appendChild(t)
                })), k.detectingConflicts && D && F((function () {
                    D.setAttributeNode(document.createAttribute(k.detectionIgnoreAttr));
                    var t = function (t, e) {
