...
class Country extends BaseModel
{
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    public function transferAgencies() {
        return $this->belongsToMany(TransferAgency::class, "receiving_agencies_countries"
            , "country_id", "transfer_agency_id");
    }
    ...
    */
    public function setImgPathAttribute($value) {
        ...
        $destination_path = "public/storage/countries";
