...
class CourseCategory extends BaseModel
{
    ...
    */
    /*protected static function boot(){
        ...
        static::addGlobalScope('scope100',function ($q){
            return $q->where('id',1);
        });
    }*/
    /*
    ...
    */
    ...
    public function courses(){
        return $this->hasMany(CourseTraining::class,'course_category_id','id');
    }
    ...
    */
    public function setImgPathAttribute($value){
        ...
        $destination_path = "public/storage/courses_categories";
