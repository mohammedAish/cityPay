                    ...
                    <div class="page-title style-boder-titel-card d-flex flex-column   ">
                        <h1 class="style-title-card px-4 py-4">
                                        <span class="fw-bolder mb-2 text-dark">
                                            <?php echo e(cp('withdraw_money_from_freelancing_platforms')); ?>
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                <div class="col-md-10 my-2">
                                    ...
                                    <label class=" style-label-form "><?php echo e(cp('FreelancingPlatforms')); ?> </label>
                                    <select name="reference_id" data-control="select2"
                                            data-placeholder="<?php echo e(cp('select_freelancing_platforms_placeholder')); ?>"
                                            data-hide-search="true"
                                            id="deposit_type"
                                            class="form-select style-select-profile style-label-form  ">
                                        <option></option>
                                        <?php $__currentLoopData = $free_lancing_platforms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $free): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($free->id); ?>"><?php echo e($free->name); ?></option>
                            ...
                            <div class="row d-none">
                                <div class="col-md-5 my-2">
                                    <label class=" style-label-form "><?php echo e(cp('min_amount_pull')); ?></label>
                                    <input type="text" class="form-control" value="" name="min_deposit_amount"
                                           id="min_deposit_amount" disabled/>
                                </div>
                                <div class="col-md-5 my-2">
                                    <label class=" style-label-form "><?php echo e(cp('max_amount_pull')); ?></label>
                            ...
                            <div class="row">
                                <div class="col-md-10 my-2">
                                    <button type="button" id="show_model"
                                            class="form-control BntAdd-Modal"><?php echo e(cp('send-withdraw-order')); ?>
                            ...
                            <div class="col-md-12">
                                <div class="d-flex style-border-row-Invouce flex-column mw-md-600px w-100">
                                    <div class="d-flex flex-stack mx-3 text-gray-800 my-3 fs-6">
                                        <div class="fw-bold pe-5 style-row-Invouce-tilte"><?php echo e(cp('freelancing-Platforms')); ?></div>
                                ...
                                <div class="d-flex style-border-row-Invouce flex-column mw-md-600px w-100">
                                    <div class="d-flex flex-stack mx-3 text-gray-800 my-3 fs-6">
                                        <div class="fw-bold pe-5 style-row-Invouce-tilte"><?php echo e(cp('amount_wanted_to_pull')); ?></div>
                                        <div class="text-end style-row-Invouce-text" id="info_amount"></div>
                                    </div>
                                </div>
                                <div class="d-flex style-border-row-Invouce flex-column mw-md-600px w-100">
                                    <div class="d-flex flex-stack mx-3 text-gray-800 my-3 fs-6">
                                        <div class="fw-bold pe-5 style-row-Invouce-tilte"><?php echo e(cp('our_pull_fee')); ?></div>
                                ...
                                <h2 class="fw-bolder my-3 style-Address-Modal d-none">
                                    ...
                                    <span class="px-1"><?php echo e(cp('ytaduwel-information')); ?></span>
                                </h2>
                                <div class="d-flex style-border-row-Invouce flex-column mw-md-600px w-100 d-none">
                                    <div class="d-flex flex-stack mx-3 text-gray-800 my-3 fs-6">
                                        <div class="fw-bold pe-5 style-row-Invouce-tilte"><?php echo e(cp('ytaduwel-account-number')); ?></div>
                                        <div class="text-end style-row-Invouce-text" id="info_agency_ytadawul_account_number"></div>
                                    </div>
                                </div>
                                <div class="d-flex style-border-row-Invouce flex-column mw-md-600px w-100 d-none">
                                    <div class="d-flex flex-stack mx-3 text-gray-800 my-3 fs-6">
                                        <div class="fw-bold pe-5 style-row-Invouce-tilte"><?php echo e(cp('ytaduwel-account-name')); ?></div>
...
<?php $__env->startSection("custom_js"); ?>
    <script type="text/javascript">
        ...
        $(document).on("change", '#deposit_type', function () {
            // var id = $(this).attr("id");
            var id = $(this).val();
            var url = '<?php echo route('list_payment_bt_platform', [':id']); ?>';
        ...
        $('#save-form').click(function (e) {
            ...
            $.easyAjax({
                url: '<?php echo e(route('save_freelancing')); ?>',
                container: '#form_data',
                type: "POST",
                redirect: true,
                beforeSend: function () {
...
<?php echo $__env->make('wallet.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ytadawu1/wallet-main/resources/views/wallet/freelancing2.blade.php ENDPATH**/ ?>