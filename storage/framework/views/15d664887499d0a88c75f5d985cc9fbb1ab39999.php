<div class="card m-5 ">
            ...
            <div class="page-title style-boder-titel-card d-flex flex-column   ">
                <h1 class="style-title-card px-4 py-4">
                                                <span class="fw-bolder mb-2 text-dark">
                                                    <?php echo e(cp('personal_identity_documentation')); ?>

                                                </span>
                </h1>
                <p class="style-title-bio-card">
                    <?php if(!empty($identity_document) && $identity_document->status == 1): ?>
                        تم توثيق هويتك بنجاح
                    <?php else: ?>
                        <?php echo e(cp('personal_identity_documentation_follow_instructions')); ?>
    ...
    <form name="profile" id="add_identity_document_form" action="<?php echo e(route('add_identity_document')); ?>" method="POST"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 my-2">
                            <label class="style-label-form">
                                ...
                                <span class="style-label-form-Badeg"> <?php echo e(cp('in_english_letters')); ?></span>
                            </label>
                            <input type="text" name="first_name_en" class="form-control" required
                                   <?php if(!empty($identity_document) && $identity_document->first_name_en): ?> 
                                   value="<?php echo e($identity_document->first_name_en); ?>" <?php endif; ?>
                                    <?php if(!empty($identity_document) && $identity_document->status == 1): ?> disabled <?php endif; ?>
                            />
                        </div>
                        <div class="col-md-6 my-2">
                            <label class="style-label-form">
                                <?php echo e(cp('family_name')); ?>

                                <span class="style-label-form-Badeg"> <?php echo e(cp('in_english_letters')); ?></span>
                            </label>
                            <input type="text" name="last_name_en" class="form-control" required
                                   <?php if(!empty($identity_document) && $identity_document->last_name_en): ?>
                                   value="<?php echo e($identity_document->last_name_en); ?>" <?php endif; ?>
                                   <?php if(!empty($identity_document) && $identity_document->status == 1): ?> disabled <?php endif; ?>
                            />
                        </div>
                            ...
                            >
                                ...
                                <?php $__currentLoopData = $collected_data['countries']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($country->id); ?>"
                                            <?php if(!empty($identity_document) && $identity_document->country_id == $country->id): ?> selected <?php endif; ?>
                                    ><?php echo e($country->name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        <div class="col-md-6 my-2">
                            <label class="style-label-form"><?php echo e(cp('birth_date')); ?></label>
                            <input type="date" name="birthdate" required
                                   placeholder="<?php echo e(cp('day')); ?>/<?php echo e(cp('month')); ?>/<?php echo e(cp('year')); ?>" class="form-control"
                                   <?php if(!empty($identity_document)  && $identity_document->birthdate): ?>
                                   value="<?php echo e($identity_document->birthdate); ?>" <?php endif; ?>
                                   <?php if(!empty($identity_document) && $identity_document->status == 1): ?> disabled <?php endif; ?>
                            />
                        </div>
                        <div class="col-md-6 my-2">
                            ...
                            <div class="input-group">
                                <input type="text" name="mobile" id="mobileNumber" style="border-radius: 0;"
                                       ...
                                       <?php if(!empty($identity_document) && $identity_document->mobile): ?> value="<?php echo e($identity_document->mobile); ?>" <?php endif; ?>
                                       <?php if(!empty($identity_document) && $identity_document->status == 1): ?> disabled <?php endif; ?>
                                />
                                <?php if(empty($identity_document) || $identity_document->status != 1): ?>
                        ...
                        <div class="col-md-6 my-2">
                            ...
                            <input type="email" name="email" class="form-control"
                                   disabled value="<?php echo e(auth('customers')->user()->email); ?>"
                            />
                        </div>
                        <div class="col-md-6 my-2">
                            <?php if(!empty($identity_document) && $identity_document->status == 1): ?>
    ...
    <form action="<?php echo e(route('update_identity_document_files')); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <input type="hidden" name="document_id" id="document_id" <?php if(!empty($identity_document)): ?> value="<?php echo e($identity_document->id); ?>" <?php endif; ?>>
        <div class="card-body" id="Display_Next_Identity_Hide" style="display: none">

            <div class="d-none">
                <h1 class="style-title-card">
                                            <span class="mb-2 text-dark">
                                                <?php echo e(cp('download_documents')); ?>

                                            </span>
                </h1>
                <p class="style-title-bio-card2">
                    <?php echo e(cp('can_use_phone')); ?>
                ...
                <span class="d-md-flex d-lg-flex d-sm-grid align-items-center me-2">
                                                ...
                                                <span class="d-flex flex-column  ">
                                                    <span class="style-title-bio-card2">
                                                        <?php echo e(cp('can_use_phone_upload_documents')); ?>

                                                        </span>

                                                    <span class="style-label-form-Badeg mb-2">
                                                        <?php echo e(cp('can_user_following_link')); ?>
                                                    ...
                                                    <span>
                                                        <a href="#"
                                                           ...
                                                           class="style-btn-copy-link "><?php echo e(cp('copy_link')); ?></a>
                                                    </span>
                                                </span>
                                            </span>
                </div>
                ...
                <div class="row style-row-identity ">
                    <div class="col-md-9">
                        <div class="d-flex align-items-center ">
                            ...
                            <div class="symbol symbol-50px me-3">
                                <?php if(!empty($identity_document) && $identity_document->status == 1 && $identity_document->document_file): ?>
                                    <img src="<?php echo e(asset($identity_document->document_file)); ?>" width="80px">
                                <?php else: ?>
                                    <span>
                            ...
                            <div>
                                <div class="style-text-Upload-identity px-3">
                                    <span style="color:#9E9E9E;"><?php echo e(cp('do_download')); ?> </span>
                                    <span style="color:#000;"><?php echo e(cp('your_document_type')); ?></span>
                                    <span>
                                                            ...
                                                            <span class="pb-2 d-md-flex flex-row">
                                                                <span class="form-check my-2 mx-1">
                                                                    <input class="form-check-input form-check-input-identity "
                                                                           type="radio"
                                                                           name="document_type"
                                                                           <?php if(!empty($identity_document) && $identity_document->status == 1 && $identity_document->document_type == "passport"): ?>
                                                                           checked
                                                                           <?php endif; ?>
                                                                           <?php if(!empty($identity_document) && $identity_document->status == 1): ?> disabled
                                                                           <?php endif; ?>
                                                                           value="passport"
                                                                           id="flexRadioDefault1"/>
                                                                    <label class="form-check-label"
                                                                           for="flexRadioDefault1"> <?php echo e(cp('passport')); ?> </label>
                                                                </span>
                                                                <span class="form-check my-2 mx-1">
                                                                    <input class="form-check-input form-check-input-identity"
                                                                           type="radio"
                                                                           name="document_type"
                                                                           <?php if(!empty($identity_document) && $identity_document->status == 1 && $identity_document->document_type == "verification_card"): ?> checked
                                                                           <?php endif; ?>
                                                                           <?php if(!empty($identity_document) && $identity_document->status == 1): ?> disabled
                                                                           <?php endif; ?>
                                                                           ...
                                                                           id="flexRadioDefault1"/>
                                                                    <label class="form-check-label"
                                                                           for="flexRadioDefault1"> <?php echo e(cp('verification_card')); ?></label>
                                                                </span>
                                                                ...
                                                                <span class="form-check my-2 mx-1">
                                                                    <input class="form-check-input form-check-input-identity"
                                                                           type="radio"
                                                                           name="document_type"
                                                                           <?php if(!empty($identity_document) && $identity_document->status == 1 && $identity_document->document_type == "driving_license"): ?> checked
                                                                           <?php endif; ?>
                                                                           <?php if(!empty($identity_document) && $identity_document->status == 1): ?> disabled
                                                                           <?php endif; ?>
                                                                           ...
                                                                           id="flexRadioDefault1"/>
                                                                    <label class="form-check-label"
                                                                           for="flexRadioDefault1"><?php echo e(cp('driving_license')); ?> </label>
                                                                </span>
                    ...
                    <div class="col-md-3 style-info-upload-identity">
                        <div class="d-flex flex-column  style-info-upload-identity-small">
                                                    <span class="style-text-Upload-identity" style="color:#000;">
                                                        <?php echo e(cp('accepted_file_formats')); ?>

                                                    </span>
                            <span class="style-text-Upload-identity pt-3" style="color:#9E9E9E;">
                                                        <?php echo e(cp('file_must_be')); ?>

                                                        png , Jpg , svg , Pdf
                                                        <?php echo e(cp('at_most')); ?> 50 MB
                                                    </span>
                        </div>
                    </div>
                </div>
                ...
                <div class="row style-row-identity ">
                    <div class="col-md-9">
                        <div class="d-flex align-items-center ">
                            <div class="symbol symbol-50px me-3">
                                <div class="symbol-label bg-light-info">
                                    <?php if(!empty($identity_document) && $identity_document->status == 1 && $identity_document->manager_address): ?>
                                        <img src="<?php echo e(asset($identity_document->manager_address)); ?>" width="80px">
                                    <?php else: ?>
                                        <span>
                                                                <svg width="58" height="74" viewBox="0 0 58 74"
                                                                     fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div>
                                <div class="style-text-Upload-identity px-3">
                                    <span style="color:#9E9E9E;"><?php echo e(cp('do_download')); ?></span>
                                    <span style="color:#000;"><?php echo e(cp('documents_confirming_manager_address')); ?></span>
                                    <span>
                                                                <svg width="12" height="12" viewBox="0 0 12 12"
                                                                     fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                    <path d="M6 12C2.6862 12 0 9.3138 0 6C0 2.6862 2.6862 0 6 0C9.3138 0 12 2.6862 12 6C12 9.3138 9.3138 12 6 12ZM6 10.8C7.27304 10.8 8.49394 10.2943 9.39411 9.39411C10.2943 8.49394 10.8 7.27304 10.8 6C10.8 4.72696 10.2943 3.50606 9.39411 2.60589C8.49394 1.70571 7.27304 1.2 6 1.2C4.72696 1.2 3.50606 1.70571 2.60589 2.60589C1.70571 3.50606 1.2 4.72696 1.2 6C1.2 7.27304 1.70571 8.49394 2.60589 9.39411C3.50606 10.2943 4.72696 10.8 6 10.8ZM5.4 7.8H6.6V9H5.4V7.8ZM5.4 3H6.6V6.6H5.4V3Z"
                    ...
                    <div class="col-md-3 style-info-upload-identity">
                        <div class="d-flex flex-column  style-info-upload-identity-small">
                            ...
                            <span class="style-text-Upload-identity pt-3" style="color:#9E9E9E;">
                                                        ...
                                                        png , Jpg , svg , Pdf
                                                        <?php echo e(cp('at_most')); ?> 50 Mb                            MB</span>
                        </div>
                    </div>
                </div>
                        ...
                        <h1 class="style-title-card">
                                                    <span class="form-check">
                                                        ...
                                                        <label class="form-check-label style-label-form"
                                                            ...
                                                            <?php echo e(cp('agree_all_information_correct')); ?>
                    ...
                    <?php if(empty($identity_document) || $identity_document->status != 1): ?>
                        <div class="col-md-4 my-2">
                            <button type="submit" class="form-control BntAdd-Modal"
                                    id="sendToCheckBtn"><?php echo e(cp('send_to_check')); ?></button>
                        </div>
                    <?php endif; ?>
                ...
                <div class="modal-header">
                    <div>
                        <h2 class="fw-bolder style-Address-Modal">
                            ...
                            <span class="px-1"><?php echo e(cp('confirm_mobile_number')); ?></span>
                        </h2>
                    </div>
                                ...
                                <div class="d-flex style-border-row-Invouce flex-column mw-md-600px w-100">
                                    ...
                                    <div class="d-flex flex-stack mx-3 text-gray-800 my-3 fs-6">
                                        ...
                                        <input type="text" name="mobile" style="border-radius: 0;"
                                               class="form-control"
                                               placeholder="<?php echo e(cp('enter_identity_mobile_verification')); ?>"
    ...
    <script>
        ...
        function ClickIdentity() {
            ...
            if (Identity_Confirem.style.display === "none") {
                ...
                toastr.info('<?php echo e(cp('please_verify_identity')); ?>')
            } else {
                Identity_Confirem.style.display = "none";
            }
        }
        ...
        $('#confimMobileBtn').click(function () {
            ...
            if (mobileNumber === undefined || mobileNumber == '') {
                ...
                $('#kt_modal_error_text').append('<?php echo e(cp('enter_mobile_number')); ?>')
                $('#kt_modal_error').modal('show')
                return;
            }

            $.ajax({
                url: '<?php echo e(route('send_mobile_verification_sms')); ?>',
                type: "post",
                data: {_token: '<?php echo e(csrf_token()); ?>', mobile: mobileNumber},
        ...
        $('#checkMobilCodeeBtn').click(function () {
            ...
            $.ajax({
                url: '<?php echo e(route('check_verification_code')); ?>',
                type: "post",
                data: {
...
<?php $__env->stopSection(); ?>    <?php /**PATH /home/ytadawu1/wallet-main/resources/views/profile/partials/identity_documentation.blade.php ENDPATH**/ ?>