<div class="tab-pane fade show " id="withdrawal_requests_tab" role="tabpanel">
    <div class="card m-5 ">
        <div class="row ">
            <div class="col-md-12 ">
                <div class="page-title style-boder-titel-card d-flex flex-column   ">
                    <h1 class="style-title-card px-4 py-4">
                                                <span class="fw-bolder mb-2 text-dark">
                                                    <?php echo e(cp('withdraw_requests')); ?>
            ...
            <div class="card-title">
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <input type="text" data-kt-user-table-filter="search"
                           id="kt_project_Withdrawal_requests_Search_All"
            ...
            <div class="dataTables_wrapper style-boder-titel-Table dt-bootstrap4 no-footer">
                <div class="table-responsive">
                    <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer"
                           id="kt_project_Withdrawal_requests">
                        <thead>
                        ...
                        <tbody>
                        <?php echo $__env->make('wallet.processes.partials.tables._withdraw_requests', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </tbody>
                        <!--end::Table body-->
                    </table>
                </div>
...
</div><?php /**PATH /home/ytadawu1/wallet-main/resources/views/wallet/processes/partials/withdrawal_requests_tab.blade.php ENDPATH**/ ?>