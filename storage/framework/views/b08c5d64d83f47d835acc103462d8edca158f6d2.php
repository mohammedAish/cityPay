                            ...
                            <div class="row">
                                <div class="row">
                                    <div class="col-md-4 my-3">
                                        <label class="style-label-form "><?php echo e(trans('lang.Iam-transferring-money-to')); ?> </label>
                                ...
                                <div class="row">
                                    <div class="col-md-4 my-3">
                                        <label class="style-label-form "><?php echo e(trans('lang.receiving-method')); ?></label>
                                        <select class="form-select form-select style-select-profile style-label-form  "
                                ...
                                <div class="row">
                                    <div class="col-md-4 my-3">
                                        <label class="style-label-form "><?php echo e(trans('lang.agency')); ?></label>
                                        <select class="form-select form-select style-select-profile style-label-form  "
                                ...
                                <div class="row">
                                    <div class="col-md-4 my-3">
                                        <label class="style-label-form"><?php echo e(trans('lang.our-fees')); ?></label>
                                        <input class="form-control" type="number" id="form_fee" min="1"
                                               value="<?php if(!empty(auth()->user()->document()) && auth()->user()->document()->status == 1): ?><?php echo e((double)$transfer_setting['verified_account_fee']); ?><?php else: ?><?php echo e((double)$transfer_setting['unverified_account_fee']); ?><?php endif; ?>"
            ...
            <div class="tab-pane fade show active" id="kt_Tab_Transfer_between_wallets" role="tabpanel">
                <div class="card m-5 ">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" id="transfer_to_wallet_form" action="<?php echo e(route('transfer_to_wallet')); ?>">
                            <?php echo csrf_field(); ?>
                            <div class="row">
                                <div class="row">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#save-form').click(function (e) {
                ...
                $.easyAjax({
                    url: '<?php echo e(route('confirm_transfer_order')); ?>',
                    container: '#form_data',
                    type: "POST",
                    redirect: true,
        ...
        $(document).on("change", '#form_country_id', function () {
            ...
            $.easyAjax({
                url: "<?php echo e(route('chooseReceivingTypes')); ?>",
                type: "get",
        ...
        $(document).on("change", '#form_receiving_mode', function () {
            ...
            var url = '<?php echo route('list_receiving_agencies_by_c_type', [':country_id',':trans_type']); ?>';
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('wallet.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ytadawu1/wallet-main/resources/views/wallet/transfer2.blade.php ENDPATH**/ ?>