  ...
  Arial, sans-serif;
   ...
   distribution of letters, as opposed to using 'Content here, content here', making it look like readable
    English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default
     ...
     <div>
         <p style="margin-right: 0px; margin-bottom: 15px;
          margin-left: 0px; font-family: &quot;Open Sans&quot;,
           Arial, sans-serif; padding: 0px; text-align: justify; color: rgb(0, 0, 0);">
           It is a long established fact that a reader will be distracted by the readable content
            of a page when looking at its layout. The point of using Lorem Ipsum is that
             ...
             the like).</p>
                ...
                <p style="margin-right: 0px; margin-bottom: 15px; margin-left: 0px; 
                font-family: &quot;Open Sans&quot;, Arial, sans-serif; 
                padding: 0px; text-align: justify; color: rgb(0, 0, 0);">
                It is a long established fact that a reader will be distracted by the readable content 
                ...
                and a search for 'lorem ipsum' will uncover many web sites still in their infancy.
                 ...
                 sometimes on purpose (injected humour and the like).</p>
                    ...
                    <p style="margin-right: 0px; margin-bottom: 15px; margin-left: 0px; 
                    font-family: &quot;Open Sans&quot;, Arial, sans-serif; padding: 0px;
...
<?php /**PATH /Users/mac/Documents/GitHub/cityPay/resources/views/home/index.blade.php ENDPATH**/ ?>