            ...
            <div class="table-responsive">
                <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer"
                    ...
                    <tr class="style-row-table">
                        ...
                        <th class="w-300px style-Title-colume-table"><?php echo e(cp('transaction')); ?></th>

                        <th class="w-100px style-Title-colume-table"><?php echo e(cp('date')); ?></th>
                        <th class="w-100px style-Title-colume-table"><?php echo e(cp('time')); ?></th>
                    ...
                    <?php $__currentLoopData = $activities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="odd  style-row-table">
                            <td class="style-text-row-table-activities" style="color: #000;">
                                ...
                                <?php endif; ?>
                                <?php echo e(cp($activity->key)); ?> <?php echo e($activity->created_at->format('Y/m/d')); ?>

                            </td>

                            <td class="style-text-row-table"><?php echo e($activity->created_at->format('Y/m/d')); ?></td>
                            <td class="style-text-row-table"><?php echo e($activity->created_at->format('H:i:s')); ?></td>
                        </tr>
...
</div><?php /**PATH /home/ytadawu1/wallet-main/resources/views/profile/partials/record_activities.blade.php ENDPATH**/ ?>