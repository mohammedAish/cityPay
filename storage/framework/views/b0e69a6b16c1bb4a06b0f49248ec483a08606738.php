<div class="wrapper d-flex flex-column flex-row-fluid">
    <div class="header align-items-stretch" id="kt_header">
        <div class="container-fluid d-flex align-items-stretch justify-content-between style-right">
            ...
            <!--end::Mobile logo-->
            <!--begin::Wrapper-->
            <div style="<?php if(app()->getLocale() == 'en'): ?> direction:ltr!important <?php else: ?> direction:rtl!important <?php endif; ?>"
                ...
                <div class="d-flex  align-items-center" id="kt_header_nav">
                    <button class="btn  style-wallet-total2  text-danger   show menu-dropdown"
                        ...
                        <?php echo e(auth()->user()->balanceFloat); ?>$
                ...
                <!--begin::Topbar-->
                <?php echo $__env->make('layouts.wallet.topbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <!--end::Topbar-->
            </div>
            <!--end::Wrapper-->
        </div>
    ...
    <div class="div-only-mobile bg-white" style="margin-top: 1%;">
        <?php echo $__env->make('layouts.wallet.topbar_mobile', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
...
<?php /**PATH /home/ytadawu1/wallet-main/resources/views/layouts/wallet/navbar.blade.php ENDPATH**/ ?>