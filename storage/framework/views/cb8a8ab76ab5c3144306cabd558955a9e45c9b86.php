                    ...
                    <div class="page-title style-boder-titel-card d-flex flex-column   ">
                        <h1 class="style-title-card px-4 py-4">
                                        <span class="fw-bolder mb-2 text-dark">
                                            <?php echo e(cp('withdrawing_funds_from_wallet')); ?>
                        ...
                        <form method="" id="form_data" action="#" autocomplete="off">
                            ...
                            <div class="row">
                                <div class="col-md-10 my-2">
                                    <label class="style-label-form"><?php echo e(cp('account')); ?></label>
                                    <input type="text" class="form-control"
                                           value="<?php echo e(auth()->user()->wallet_code_symbol); ?>" disabled/>
                                </div>
                            </div>
                            <div class="col-md-10 my-2">
                                <label class=" style-label-form "><?php echo e(cp('withdrawal_method')); ?></label>
                                <select name="agency_id" id="form_agency_id" data-control="select2"
                                        data-placeholder="<?php echo e(cp('select_withdrawal_method')); ?>"
                                        data-hide-search="true"
                                        class="form-select style-select-profile style-label-form  ">
                                    <option></option>
                                    <?php echo $__env->make("wallet.agency_select2_agencies",["agencies"=> $accounts], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

                                </select>
                                <span class="style-bio-Modal-trasfer"><?php echo e(cp('withdrawal_method_description')); ?></span>
                            </div>
                            <div class="row">
                            ...
                            <div class="row d-none">
                                <div class="col-md-5 my-2">
                                    <label class="style-label-form"><?php echo e(cp('min_withdraw_amount')); ?></label>
                                    <input type="text" class="form-control" value="" name="min_deposit_amount"
                                           id="min_deposit_amount" placeholder="" disabled>
                                </div>
                                <div class="col-md-5 my-2">
                                    <label class=" style-label-form "><?php echo e(cp('max_withdraw_amount')); ?></label>
                            ...
                            <div class="row">
                                <div class="col-md-10 my-2">
                                    <button type="button" id="show_model"
                                            class="form-control BntAdd-Modal"><?php echo e(cp('Withdrawal')); ?>
                        ...
                        <form class="form" action="#" autocomplete="off">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="d-flex style-border-row-Invouce flex-column mw-md-600px w-100">
                                        <div class="d-flex flex-stack mx-3 text-gray-800 my-3 fs-6">
                                            <div class="fw-bold pe-5 style-row-Invouce-tilte"><?php echo e(cp('our-fees')); ?>
                                ...
                                <div class="col-md-12 my-2">
                                    <div class="col-md-12">
                                        ...
                                        <div class="d-flex style-border-row-Invouce flex-column mw-md-600px w-100" id="success_edit_customer_agency_acc_number_cont" style="display: none;">
                                            <div class="d-flex flex-stack mx-3 text-gray-800 my-3 fs-6">
                                                <div class="fw-bold pe-5 style-row-Invouce-tilte">رقم الحساب</div>
                                                <div class="text-end style-row-Invouce-text" id="success_edit_customer_agency_acc_number"><?php echo e(auth()->user()->wallet_code_symbol); ?></div>
                                            </div>
                                        </div>
                                        <div class="d-flex style-border-row-Invouce flex-column mw-md-600px w-100" id="success_edit_customer_agency_acc_name_cont" style="display: none;">
                                            <div class="d-flex flex-stack mx-3 text-gray-800 my-3 fs-6">
                                                <div class="fw-bold pe-5 style-row-Invouce-tilte">اسم الحساب</div>
                                                <div class="text-end style-row-Invouce-text" id="success_edit_customer_agency_acc_name"><?php echo e(auth()->user()->first_name); ?></div>
                                            </div>
                                        </div>
...
<?php $__env->startSection("custom_js"); ?>
    ...
    <script type="text/javascript">
        ...
        function update_fee(agency_id, amount) {
            var url = '<?php echo route('withdraw_percent', [':amount',':agency_id']); ?>';
        ...
        $('#show_model').click(function (e) {
            ...
            $.easyAjax({
                url: '<?php echo e(route('get_customer_balance')); ?>',
                container: '#form_data',
                type: "GET",
                success: function (response) {
                    ...
                    if (response.balance > total_amount) {
                        ...
                        if (deposit_agency_id > 0) {
                            ...
                            $('#kt_modal_error_text').append('<?php echo e(cp("agency_id_field_is_required")); ?>')
        ...
        $('#save-form').click(function (e) {
            ...
            $.easyAjax({
                url: '<?php echo e(route('confirm_internal_withdraw')); ?>',
                container: '#form_data',
                type: "POST",
                redirect: true,
...
<?php echo $__env->make('wallet.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ytadawu1/wallet-main/resources/views/wallet/withdraw.blade.php ENDPATH**/ ?>