                    ...
                    <table class="table align-items-center table-light">
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $howItWorks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $testi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td><?php echo e(description_shortener(@$testi->value->details)); ?></td>
                                <td>
                                    <button type="button" class="btn btn-rounded btn-primary text-white editBtn"
                                            data-title="<?php echo e($testi->value->title); ?>"
                                            data-icon="<?php echo e($testi->value->icon); ?>"
                                            data-details="<?php echo e($testi->value->details); ?>"
    ...
    <div id="editModal" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?php echo e(route('admin.frontend.update', $testi->id)); ?>" method="POST"
                      enctype="multipart/form-data">
                    <input type="hidden" name="key" value="flowstep">
...
<?php $__env->startPush('breadcrumb-plugins'); ?>
    <a href="<?php echo e(route('admin.frontend.flowstep.new')); ?>" class="btn btn-success"><i class="fa fa-fw fa-plus"></i>Add New</a>
<?php $__env->stopPush(); ?>
...
<?php $__env->startPush('after_scripts'); ?>
    ...
    <script>
        ...
        $('.editBtn').on('click', function () {
            ...
            modal.find('input[name=details]').val($(this).data('details'));
...
<?php echo $__env->make(backpack_view('blank'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ytadawu1/wallet-main/resources/views/vendor/backpack/base/frontend/flowstep.blade.php ENDPATH**/ ?>