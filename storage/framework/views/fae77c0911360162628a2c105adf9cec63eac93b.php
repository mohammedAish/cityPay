    ...
    <div class="topbar style-respoinsive-hide-icons-header-disktop d-flex align-items-stretch flex-shrink-0">
        ...
        <div class="d-flex align-items-center ms-1 ms-lg-3">
            ...
            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-200px"
                ...
                <!--begin::Menu item-->
                <div class="menu-item px-3 my-1">
                    <a href="<?php echo e(route("profile.dashboard") . '#kt_Record_activities_tab'); ?>" class="style-menu-link px-3 active">
                                                    <span class="menu-icon">
                ...
                <div class="menu-item px-3">
                    <div class="menu-content d-flex align-items-center px-3">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <a href="#"
                               class="fw-bold text-muted  style-text-number-wallet2 text-hover-primary fs-7" id="wallet_code_symbol"><?php echo e(auth()->user()->wallet_code_symbol); ?></a>
                        </div>
                        <!--end::Username-->
                    </div>
                </div>
...
</script><?php /**PATH /home/ytadawu1/wallet-main/resources/views/layouts/wallet/topbar.blade.php ENDPATH**/ ?>