<?php $__currentLoopData = $pay_bills_orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <tr class="odd  style-row-table">
        <td class="style-text-row-table"><?php echo e($order->created_at->format('Y/m/d')); ?></td>
        <td class="style-text-row-table">$<?php echo e($order->real_price); ?></td>


        <td class="style-text-row-table">$<?php echo e($order->commission_fee); ?></td>
        <td class="style-text-row-table">$<?php echo e($order->final_price); ?></td>

        <td class="style-text-row-table">
            <button type="button" class="btn" data-bs-toggle="modal"
                    data-bs-target="#kt_modal_Bill_payment_requests">
                <?php echo e($order->id); ?>
        ...
        <td class="style-text-row-table">
            ...
            <?php endif; ?>
            <span class="px-1"><?php echo e($order->current_status == 'pending' ? cp('pending') : cp('completed')); ?></span>
        </td>
    </tr>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>    <?php /**PATH /home/ytadawu1/wallet-main/resources/views/wallet/processes/partials/tables/_pay_bills_requests.blade.php ENDPATH**/ ?>