...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <form action="<?php echo e(route('admin.frontend.update', $caption->id)); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="card-body">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Title</label>
                                    <input type="text" class="form-control" placeholder="Member Name" name="title" value="<?php echo e(@$caption->value->title); ?>" required/>
                                </div>
                                <div class="form-group">
                                    <label>Short Details</label>
                                    <input type="text" class="form-control" placeholder="Member Designation" name="short_details" value="<?php echo e(@$caption->value->short_details); ?>" required/>
                                </div>
        ...
        <div class="card">
            <div class="table-responsive table-responsive-xl">
                <table class="table align-items-center table-light">
                    ...
                    <tbody class="list">
                    <?php $__empty_1 = true; $__currentLoopData = $howItWorks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td><?php echo $item->value->icon; ?></td>
                            <td><?php echo e($item->value->title); ?></td>
                            <td><?php echo e($item->value->sub_title); ?></td>
                            <td>
                                <button type="button" class="btn btn-rounded btn-primary editBtn" data-title="<?php echo e($item->value->title); ?>" data-icon="<?php echo e($item->value->icon); ?>"
                                        data-sub_title="<?php echo e($item->value->sub_title); ?>" data-action="<?php echo e(route('admin.frontend.update', $item->id)); ?>"><i class="fa fa-edit"></i></button>
...
<?php echo $__env->make(backpack_view('blank'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ytadawu1/wallet-main/resources/views/vendor/backpack/base/frontend/whychoose.blade.php ENDPATH**/ ?>