<?php $__currentLoopData = $freelancing_orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <tr class="odd  style-row-table">
        ...
        <td class="style-text-row-table"><?php echo e($order->id); ?></td>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>    <?php /**PATH /home/ytadawu1/wallet-main/resources/views/wallet/processes/partials/tables/_freelancing_requests.blade.php ENDPATH**/ ?>