                    ...
                    <div class="col-md-6">
                        <form method="" id="form_data" action="#" autocomplete="off">
                            ...
                            <div class="col-md-10 my-2">
                                <label class=" style-label-form "><?php echo e(cp('select_account')); ?></label>
                                <input type="text" class="form-control"
                                       value="<?php echo e(auth()->user()->wallet_code_symbol); ?>" disabled/>
                            </div>
                            <div class="col-md-10 my-2">
                                <label class=" style-label-form "><?php echo e(cp('deposit_system')); ?></label>
                                <input type="hidden" name="deposit_method" value="cash" id="deposit_method">
                                
                                
                                <select name="deposit_type" data-control="select2"
                                        data-placeholder="<?php echo e(cp('deposit_system_placeholder')); ?>" data-hide-search="true"
                            ...
                            <div class="col-md-10 my-2">
                                <label class=" style-label-form "><?php echo e(cp('agency')); ?></label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5 my-2">
                                    <label class=" style-label-form "><?php echo e(cp('currency')); ?></label>
                                    
                                    <select name="currency_id" data-control="select2" id="currency_id"
                                            data-placeholder="<?php echo e(cp('select_currency')); ?>"
                                            data-hide-search="true"
                                            class="form-select style-select-profile style-label-form ">
                                        <option></option>
                            ...
                            <div class="row d-none">
                                <div class="col-md-5 my-2">
                                    <label class=" style-label-form "><?php echo e(cp('min_amount_withd')); ?></label>
                                    <input type="text" class="form-control" value="" name="min_deposit_amount"
                                           id="min_deposit_amount" disabled/>
                                </div>
                                <div class="col-md-5 my-2">
                                    <label class=" style-label-form "><?php echo e(cp('max_amount_withd')); ?></label>
                                    <input type="text" class="form-control" value="" name="max_deposit_amount"
                                           id="max_deposit_amount" disabled/>
                                </div>
                            </div>
                            <?php echo $__env->make('wallet._master_key', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            <div class="row">
                                <div class="col-md-10 my-2">
                                            ...
                                            <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                                                <div class="flex-grow-1 ">
                                                    ...
                                                    <p class="style-box-wallet-info-Big-Title-text">
                                                        <?php echo e(cp('deposit_instructions_text')); ?>

                                                    </p>
                                                    <p class="style-box-wallet-info-Big-list-info-text">
                                                        <?php echo cp('deposit_instructions_description'); ?>
                                                    ...
                                                    <ul class=" style-box-wallet-info-Big-list-info">
                                                        ...
                                                        <li class="style-box-wallet-info-Big-list-info-text">
                                                            ...
                                                            <?php echo e(cp('deposit_instructions_step_1')); ?>

                                                        </li>
                                                        <li class="style-box-wallet-info-Big-list-info-text">
                                                            <i class="fas fa-check text-white px-1"></i>
                                                        <?php echo e(cp('deposit_instructions_step_2')); ?>

                                                        <li class="style-box-wallet-info-Big-list-info-text">
                                                            <i class="fas fa-check text-white px-1"></i>
                                                            <?php echo e(cp('deposit_instructions_step_3')); ?>

                                                        </li>
                                                        <li class="style-box-wallet-info-Big-list-info-text">
                                                            <i class="fas fa-check text-white px-1"></i>
                                                            <?php echo e(cp('deposit_instructions_step_4')); ?>

                                                        </li>
                                                        <li class="style-box-wallet-info-Big-list-info-text">
                                                            <i class="fas fa-check text-white px-1"></i>
                                                            <?php echo e(cp('deposit_instructions_step_5')); ?>
                    ...
                    <div class="modal-header">
                        ...
                        <div>
                            <h2 class="fw-bolder style-Address-Modal">
                                ...
                                <span class="px-1"><?php echo e(cp('process_details')); ?></span>
                            </h2>
                            <h2 class="pt-1">
                                ...
                                <span class="style-bio-Modal-trasfer"><?php echo e(cp('process_details_description')); ?></span>
                            </h2>
                        </div>
                                ...
                                <div class="col-md-12">
                                    <div class="d-flex style-border-row-Invouce flex-column mw-md-600px w-100">
                                        <div class="d-flex flex-stack mx-3 text-gray-800 my-3 fs-6">
                                            ...
                                            <div class="text-end style-row-Invouce-text"><?php echo e($process_number); ?></div>
                                        </div>
                                    </div>
                                    <div class="d-flex style-border-row-Invouce flex-column mw-md-600px w-100">
                                        <div class="d-flex flex-stack mx-3 text-gray-800 my-3 fs-6">
                                    ...
                                    <div class="d-flex style-border-row-Invouce flex-column mw-md-600px w-100">
                                        <div class="d-flex flex-stack mx-3 text-gray-800 my-3 fs-6">
                                            <div class="fw-bold pe-5 style-row-Invouce-tilte"><?php echo e(cp('amount_to_deposited_into_wallet_in_dollars')); ?>
                                    ...
                                    <div class="d-flex style-border-row-Invouce flex-column mw-md-600px w-100">
                                        <div class="d-flex flex-stack mx-3 text-gray-800 my-3 fs-6">
                                            <div class="fw-bold pe-5 style-row-Invouce-tilte"><?php echo e(cp('amount_to_be_paid_currency')); ?>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="d-flex style-border-row-Invouce flex-column mw-md-600px w-100">
                                            <div class="d-flex flex-stack mx-3 text-gray-800 my-3 fs-6">
                                                ...
                                                <div class="text-end style-row-Invouce-text"
                                                     id="recipient_name"><?php echo e(auth()->user()->first_name); ?></div>
                                                <div class="text-end style-row-Invouce-text"
                                        ...
                                        <div class="d-flex style-border-row-Invouce flex-column mw-md-600px w-100">
                                            <div class="d-flex flex-stack mx-3 text-gray-800 my-3 fs-6">
                                                ...
                                                <div class="text-end style-row-Invouce-text"
                                                     id="recipient_phone_number"><?php echo e(auth()->user()->phone); ?></div>
                                                <div class="text-end style-row-Invouce-text"
                                        ...
                                        <div class="d-flex style-border-row-Invouce flex-column mw-md-600px w-100">
                                            <div class="d-flex flex-stack mx-3 text-gray-800 my-3 fs-6">
                                                ...
                                                <div class="text-end style-row-Invouce-text"
                                                     id="recipient_address"><?php echo e(auth()->user()->country->name); ?></div>
                                                <div class="text-end style-row-Invouce-text"
                                        ...
                                        <div class="d-flex style-border-row-Invouce flex-column mw-md-600px w-100">
                                            <div class="d-flex flex-stack mx-3 text-gray-800 my-3 fs-6">
                                                ...
                                                <div class="text-end style-row-Invouce-text"
                                                     id="recipient_acc_number"><?php echo e(auth()->user()->wallet_code_symbol); ?></div>
                                                <div class="text-end style-row-Invouce-text"
                                        ...
                                        <div class="d-flex style-border-row-Invouce flex-column mw-md-600px w-100 d-none">
                                            <div class="d-flex flex-stack mx-3 text-gray-800 my-3 fs-6">
                                                ...
                                                <div class="text-end style-row-Invouce-text"
                                                     id="recipient_email"><?php echo e(auth()->user()->email); ?></div>
                                                <div class="text-end style-row-Invouce-text"
...
<?php $__env->startSection("custom_js"); ?>
    <script type="text/javascript">
        ...
        $('#deposit_type').change(function () {
            ...
            var url = '<?php echo route('getDepositAgencyByDepositMethod', [':type_id']); ?>';
        ...
        $('#show_model').click(function (e) {
            ...
            if (agency_section > 0 && currency_id > 0) {
                ...
                if (amount <= max && amount >= min) {
                    $.when(checkUserMasterKey($('#master_key').val(), '<?php echo e(route('check_user_master_key')); ?>')).done(function (response) {
                        if (response.success) {
                            $("#info_selected_currency").append($('#currency_id').find('option:selected').text());
                            $('#model_operation').modal('show');
                        } else {
                    ...
                    $('#kt_modal_rang_error_text').append('<?php echo e(cp("amount_must_be_between_the_allowed_range")); ?>')
                ...
                var txt = '<?php echo e(cp('must_enter_all_data')); ?>';
                if (deposit_agency_id === undefined || deposit_agency_id <= 0) {
                    txt = "<?php echo e(cp('agency_and_other_fields_are_required')); ?>";
                } else if (currency_id === undefined || currency_id <= 0) {
                    txt = '<?php echo e(cp('currency_id_is_required')); ?>';
                }
        ...
        $('#save-form').click(function (e) {
            e.preventDefault();
            $.easyAjax({
                url: '<?php echo e(route('wallet.confirm_deposit')); ?>',
                container: '#form_data',
                type: "POST",
                redirect: true,
                ...
                beforeSend: function () {
                    ...
                    $("#save-form").text("<?php echo e(cp('wait_process_to_finish')); ?>");
                },
                complete: function (xhr, status) {
                    $("#save-form").attr("disabled", true);
                    $("#save-form").text("<?php echo e(cp('confirm')); ?>");
                },
                success: function (response) {
                    ...
                    $("#save-form").prop("disabled", false);
                    $("#save-form").text('<?php echo e(trans('lang.confirm')); ?>');
                },
            })
        });
...
<?php echo $__env->make('wallet.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ytadawu1/wallet-main/resources/views/wallet/deposit.blade.php ENDPATH**/ ?>