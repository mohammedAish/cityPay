<?php $__currentLoopData = $withdraw_orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <tr class="odd  style-row-table">
        ...
        <td class="style-text-row-table">$<?php echo e($order->final_amount); ?></td>
        <td class="style-text-row-table"><?php echo e($order->deposit_type); ?></td>
        <td class="style-text-row-table">
            <button type="button" class="btn show-withdraw-details-modal"
                    order_account_name="<?php echo e($order->agency->customer_agency_acc_name); ?>"
                    order_account_number="<?php echo e($order->agency->customer_agency_acc_number); ?>"
                    ...
                    order_commission="<?php echo e($order->fee_amount); ?>"
                    all_data="<?php echo e($order); ?>"
            >
                <?php echo e($order->id); ?>
        ...
        <td class="style-text-row-table">
            <?php if($order->current_status == 'confirmed'): ?>
            ...
            <?php endif; ?>
            <span class="px-1"><?php echo e(cp($order->current_status)); ?></span>
        </td>
    </tr>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>    <?php /**PATH /home/ytadawu1/wallet-main/resources/views/wallet/processes/partials/tables/_withdraw_requests.blade.php ENDPATH**/ ?>