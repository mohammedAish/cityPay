<?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <tr class="odd style-row-table">
        ...
        <td class="style-text-row-table"><?php echo e(cp($order->order_type)); ?></td>
        ...
        <td class="style-text-row-table">
            <?php if($order->current_status == 'pending'): ?>
                ...
                <span class="px-1"><?php echo e(cp('pending')); ?></span>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>    <?php /**PATH /home/ytadawu1/wallet-main/resources/views/wallet/processes/partials/tables/_all_processes.blade.php ENDPATH**/ ?>